...
public class ErrowAdapter extends RecyclerView.Adapter<ErrowAdapter.ViewHolder> {

    private Context context;
    private List<ErrowBean> datas;
    private OnItemClickListener mOnItemClickListener;

    public ErrowAdapter(Context context,List<ErrowBean> dats){
        this.datas=dats;
    ...
    @NonNull
    @Override
    public ErrowAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(context).inflate(R.layout.errow_item,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ErrowAdapter.ViewHolder holder, int position) {
