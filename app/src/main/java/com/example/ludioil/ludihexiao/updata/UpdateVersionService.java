...
public class UpdateVersionService extends Service {
    ...
    public void onCreate() {
        ...
        updateFile = new File(SDCardUtils.getRootDirectory() + "/updateVersion/landOil.apk");

        nm = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
        notification = new Notification();
        notification.icon = R.drawable.icon_land_oil;
...
//                startActivity(installIntent);
                ...
                if (Build.VERSION.SDK_INT >= 24) {
                    ...
                    Uri uri = FileProvider.getUriForFile(getApplication(), "com.example.ludioil.ludihexiao.updata.UpdateVersionService", updateFile);
            ...
            public void onFailure(HttpException error, String msg) {
                ...
                if (error.getExceptionCode() == 0) {
                    ...
                    // 更改文字
                    notification.contentView.setTextViewText(R.id.msg, getString(R.string.app_name));
                    // 更改文字
            ...
            public void onLoading(long total, long current, boolean isUploading) {
                ...
                notification.contentView.setTextViewText(R.id.msg, "正在下载:" + getString(R.string.app_name));
                // 更改文字
...
//				notification.contentView.setOnClickPendingIntent(R.id.btnStartStop, pendingIntent);
            ...
            @Override
            public void onStart() {
                notification.contentView.setTextViewText(R.id.msg, "开始下载：" + getString(R.string.app_name));
                nm.notify(titleId, notification);
            }
