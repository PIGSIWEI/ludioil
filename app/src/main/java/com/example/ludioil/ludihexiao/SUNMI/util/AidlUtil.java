package com.example.ludioil.ludihexiao.SUNMI.util;
...
import com.example.ludioil.ludihexiao.SUNMI.bean.TableItem;
...
public class AidlUtil {
     ...
     * 获取服务器打印信息
     */
    public void printServerText(String content, float size, boolean isBold, boolean isUnderLine){
        if (woyouService == null) {
            Toast.makeText(context,"The service has been disconnected!",Toast.LENGTH_LONG).show();
            return;
        }
     ...
     * 居中文字
     */
    public void centerPrint(String content, float size, boolean isBold, boolean isUnderLine){
        try {
            woyouService.setAlignment(1, null);
            if (woyouService == null) {
                Toast.makeText(context,"The service has been disconnected!",Toast.LENGTH_LONG).show();
